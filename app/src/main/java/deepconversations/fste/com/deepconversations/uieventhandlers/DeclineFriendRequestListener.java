...
public class DeclineFriendRequestListener implements View.OnClickListener {

    Context ctx;
    FriendStatus data;
    public DeclineFriendRequestListener(Context ctx, FriendStatus friendStatus){
        this.ctx = ctx;
        this.data = friendStatus;
    }
    @Override
    public void onClick(View v) {
        RealtimeDbWriter.getInstance(ctx, false).declineFriendStatus(data);
    }
}
